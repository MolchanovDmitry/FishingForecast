object Deps {
    ...
    object Sqldelight {
        ...
        const val android_driver = "app.cash.sqldelight:android-driver:$sqlDelightVersion"
        const val runtime = "app.cash.sqldelight:runtime:$sqlDelightVersion"
        const val coroutinesExt = "app.cash.sqldelight:coroutines-extensions:$sqlDelightVersion"
    }
