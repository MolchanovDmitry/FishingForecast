...
import dmitry.molchanov.fishingforecast.ui.NavItem
import dmitry.molchanov.fishingforecast.ui.Screen
import dmitry.molchanov.fishingforecast.ui.map.MapScreen
import dmitry.molchanov.fishingforecast.ui.profile.ProfileScreen
import dmitry.molchanov.fishingforecast.ui.result.ResultDetailScreen
import dmitry.molchanov.fishingforecast.ui.result.ResultScreen
import dmitry.molchanov.fishingforecast.ui.setting.ForecastSettingsList
import dmitry.molchanov.fishingforecast.ui.weather.WeatherDebugScreen
import dmitry.molchanov.fishingforecast.ui.weather.WeatherScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.ResultDetails.label) {
                val result =
                    it.arguments?.getString("result")?.deserialize<Result>() ?: return@composable
